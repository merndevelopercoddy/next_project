...
const PostWidget = ({slug , categories}) => {
  ...
  return (
    ...
    <div className='bg-white shadow-lg rounded-lg text-black p-0 lg:p-8 pb-12 mb-12'>
      <h3 className='text-center text-xl border-b mb-2'>{slug ? "Slug ochilgan holat" : "Asosiy sahifadasiz"}</h3>
      {relatedPosts.map(post=>(
        <div key={post.title} className='flex items-center w-full mb-4'>
          ...
          <div className='flex-grow text-blue-700 hover:text-black font-bold text-xl'>
